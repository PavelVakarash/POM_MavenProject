...
public class EbayBrokenLinksImagesPage extends BasePage {

    public EbayBrokenLinksImagesPage(WebDriver driver) {
        super(driver);
    }
    ...
    public EbayBrokenLinksImagesPage checkBrokenLinks() {
    ...
    public EbayBrokenLinksImagesPage checkBrokenImages() {
